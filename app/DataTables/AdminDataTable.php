...
class AdminDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('updated_by', function ($row) {
                ...
                $query->join('users as updater', 'users.updated_by', '=', 'updater.id')
                    ->select(['users.*', 'updater.name as updater_name'])
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->minifiedAjax(route('configurations.admin.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('roles')->title("Admin Roles")->orderable(true)->searchable(true),
            Column::computed('name')->title("Admin Name")->orderable(true)->searchable(true),
            Column::computed('email')->title("Admin Email")->orderable(true)->searchable(true),
