...
class PriceListDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('updated_by', function ($row) {
                ...
                $query->join('users as updater', 'cms_price_lists.updated_by', '=', 'updater.id')
                    ->select(['cms_price_lists.*', 'updater.name as updater_name'])
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->minifiedAjax(route('cms.price-lists.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('price_name')->title("Price Name")->orderable(true)->searchable(true),
            Column::computed('price_normal')->title("Price Normal")->orderable(true)->searchable(true),
            Column::computed('price_promo')->title("Price Promo")->orderable(true)->searchable(true),
