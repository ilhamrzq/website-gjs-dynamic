...
class GalleryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('photo', function ($row) {
                ...
                foreach ($sortedImages as $index => $image) {
                    ...
                    <div class="carousel-item ' . $activeClass . '">
                        <img class="d-block img-fluid mx-auto" src="' . $imagePath . '" alt="Gallery Image">
                    </div>';
                }
            ...
            ->addColumn('updated_by', function ($row) {
                ...
                $query->join('users as updater', 'cms_gallery_categories.updated_by', '=', 'updater.id')
                    ->select(['cms_gallery_categories.*', 'updater.name as updater_name'])
    ...
    {
        return $model->newQuery()->with(['user', 'gallery']);
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->minifiedAjax(route('cms.galleries.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('category_name_id')->title('Category Name ID')->orderable(true)->searchable(true),
            Column::computed('category_name_en')->title('Category Name EN')->orderable(true)->searchable(true),
