...
class SponsorshipDataTable extends DataTable
{
            ...
            ->addColumn('photo', function ($row) {
                ...
                foreach ($sortedImages as $index => $image) {
                    ...
                    <div class="carousel-item ' . $activeClass . '">
                        <img class="d-block img-fluid mx-auto" src="' . $imagePath . '" alt="Sponsorship Images">
                    </div>';
                }
    ...
    {
        return $model->newQuery()->with(['user', 'sponsorshipImages']);
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->minifiedAjax(route('cms.sponsorships.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('sponsor_type_name')->orderable(true)->searchable(true),
