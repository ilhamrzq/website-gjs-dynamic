...
class BookingPageDataTable extends DataTable
{
    use DataTableCustom;
    ...
    {
        return $this->builder()
                    ->setTableId('bookingpage-table')
                    ->columns($this->getColumns())
                    ->minifiedAjax(route('cms.booking-page.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('page_name')->title('Page Name')->orderable(true)->searchable(true),
    ...
    {
        return 'BookingPage_' . date('YmdHis');
    }
}
