...
class CompanyProfileDataTable extends DataTable
{
    use DataTableCustom;
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('updated_by', function ($row) {
                ...
                $query->join('users as updater', 'cms_company_profile.updated_by', '=', 'updater.id')
                    ->select(['cms_company_profile.*', 'updater.name as updater_name'])
     ...
     */
    public function query(CompanyProfile $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->minifiedAjax(route('cms.profile.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('company_email')->title("Email")->orderable(true)->searchable(true),
            Column::computed('company_phone_number')->title("Phone Number")->orderable(true)->searchable(true),
            Column::computed('company_address')->title("Address")->orderable(true)->searchable(true),
    ...
    {
        return 'CompanyProfile_' . date('YmdHis');
    }
}
