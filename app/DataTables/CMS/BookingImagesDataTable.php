...
class BookingImagesDataTable extends DataTable
{
    use DataTableCustom;
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('photo', function ($row) {
                ...
                foreach ($sortedImages as $index => $image) {
                    ...
                    <div class="carousel-item ' . $activeClass . '">
                        <img class="d-block img-fluid mx-auto" src="' . $imagePath . '" alt="Booking Page Image">
                    </div>';
                }
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="' . $photoId . '_label">' . "Gallery Images" . '</h5>
            ...
            ->addColumn('updated_by', function ($row) {
                ...
                $query->join('users as updater', 'cms_booking_page.updated_by', '=', 'updater.id')
                    ->select(['cms_booking_page.*', 'updater.name as updater_name'])
     ...
     */
    public function query(BookingPage $model): QueryBuilder
    {
        return $model->newQuery()->with(['user', 'images']);
    }
    ...
    {
        return $this->builder()
                    ->setTableId('bookingimages-table')
                    ->minifiedAjax(route('cms.bookings.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
           Column::computed('checkbox')
            ...
            Column::computed('page_name')->title('Category Name ID')->orderable(true)->searchable(true),
    ...
    {
        return 'BookingImages_' . date('YmdHis');
    }
}
