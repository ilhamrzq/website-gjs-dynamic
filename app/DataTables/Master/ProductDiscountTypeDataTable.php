...
class ProductDiscountTypeDataTable extends DataTable
{
    use DataTableCustom;
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('updated_by', function ($row) {
                ...
                $query->join('users as updater', 'master_product_discount_types.updated_by', '=', 'updater.id')
                ->select(['master_product_discount_types.*', 'updater.name as updater_name'])
     ...
     */
    public function query(ProductDiscountType $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('productdiscounttype-table')
                    ->columns($this->getColumns())
                    ->minifiedAjax(route('products.discount.type.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('discount_type_name')->title('Discount Type Name')->orderable(true)->searchable(true),
            Column::make('discount_type_description')->title('Discount Type Description')->orderable(true)->searchable(true),
    ...
    {
        return 'ProductDiscountType_' . date('YmdHis');
    }
}
