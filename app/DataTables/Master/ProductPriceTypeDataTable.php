...
class ProductPriceTypeDataTable extends DataTable
{
    use DataTableCustom;
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('updated_by', function ($row) {
                ...
                $query->join('users as updater', 'master_product_price_types.updated_by', '=', 'updater.id')
                    ->select(['master_product_price_types.*', 'updater.name as updater_name'])
     ...
     */
    public function query(ProductPriceType $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('productpricetype-table')
                    ->columns($this->getColumns())
                    ->minifiedAjax(route('products.price.type.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('price_type_name')->orderable(true)->searchable(true),
            Column::make('price_type_description')->orderable(true)->searchable(true),
    ...
    {
        return 'ProductPriceType_' . date('YmdHis');
    }
}
