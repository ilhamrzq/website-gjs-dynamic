...
class TableDiscountTypeDataTable extends DataTable
{
    use DataTableCustom;
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('updated_by', function ($row) {
                ...
                $query->join('users as updater', 'master_table_discount_types.updated_by', '=', 'updater.id')
                ->select(['master_table_discount_types.*', 'updater.name as updater_name'])
     ...
     */
    public function query(TableDiscountType $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('tablediscounttype-table')
                    ->columns($this->getColumns())
                    ->minifiedAjax(route('tables.discount.type.index', [], true))
                    //->dom('Bfrtip')
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
    ...
    {
        return 'TableDiscountType_' . date('YmdHis');
    }
}
