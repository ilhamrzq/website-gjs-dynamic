...
class MembershipDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('updated_by', function ($row) {
                ...
                $query->join('users as updater', 'master_memberships.updated_by', '=', 'updater.id')
                    ->select(['master_memberships.*', 'updater.name as updater_name'])
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->minifiedAjax(route('memberships.type.index', [], true))
                    //->dom('Bfrtip')
                    ->orderBy(1)
                    ->selectStyleSingle()
                    ->buttons([
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('membership_name')->orderable(true)->searchable(true),
            Column::make('membership_description')->orderable(true)->searchable(true),
            Column::make('membership_price')->orderable(true)->searchable(true),
