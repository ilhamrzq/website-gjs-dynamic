...
class BookingPageImage extends Model
{
    ...
    protected $table = 'cms_booking_page_images';
    ...
    public static function imagesByPage($categoryId)
    {
        return self::with('user')->where('booking_page_id', $categoryId)->orderBy('id')->get();
    }
