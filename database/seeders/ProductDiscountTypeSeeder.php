...
class ProductDiscountTypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (DB::getDriverName() === 'mysql') {
            ...
            // di navicat pgsql
            DB::statement('TRUNCATE master_product_discount_types RESTART IDENTITY CASCADE;');
        }

        $discountType = [
            [
                "discount_type_name" => "Member",
                "discount_type_description" => "Member discount type",
                'created_at' => now(),
                'updated_at' => now(),
                'created_by' => 1,
                'updated_by' => 1,
            ...
            [
                "discount_type_name" => "Public",
                "discount_type_description" => "Public discount type",
                'created_at' => now(),
                'updated_at' => now(),
                'created_by' => 1,
                'updated_by' => 1,
        ...
        DB::table('master_product_discount_types')->insert($discountType);
    }
}
