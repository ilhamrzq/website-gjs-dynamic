...
export default function ButtonNavbarDropdown({ name, hrefTo, iconMaterial }) {
  return (
    <Link href={hrefTo} className="menu duration-300 hover:ease-in-out scroll-smooth hover:scale-105 flex flex-row justify-between items-center border-b-[#DDDDDD] border-b-[1px] py-4">
