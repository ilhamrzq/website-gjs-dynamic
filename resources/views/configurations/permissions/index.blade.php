<x-app-layout>
                ...
                <div class="card">
                    <div class="card-header align-items-center d-md-flex">
                        ...
                        <div class="flex-shrink-0">
                            @can('create configurations/permission')
                    ...
                    @can('delete configurations/permission')
                        <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            multipleDelete("{{ route('configurations.permission.multiple.delete') }}", 'permission-table');
