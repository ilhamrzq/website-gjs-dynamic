<x-app-layout>
                ...
                <div class="card">
                    <div class="card-header align-items-center d-md-flex">
                        ...
                        <div class="flex-shrink-0">
                            @can('create products/discount/type')
                    ...
                    @can('delete products/discount/type')
                        <div class="row">
    ...
    <script>
       $(document).ready(function () {
        ...
        multipleDelete("{{ route('products.discount.type.multiple.destroy') }}", 'productdiscounttype-table');
        });
    </script>
    @endpush
</x-app-layout>