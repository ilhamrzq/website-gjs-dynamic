                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                                <span class="counter-value" data-target="{{ $total_venues }}">0</span>
                                            </h4>
                                            {{-- <h4 class="fs-22 fw-semibold ff-secondary mb-4">$<span class="counter-value"
                                                    data-target="559.25">0</span>k </h4> --}}
                                            <a href="{{ route('venues.places.index') }}"
                                                class="text-decoration-underline">View all venues</a>
                                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Products
                                            </p>
                                        </div>
                                        {{-- <div class="flex-shrink-0">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                                <span class="counter-value" data-target="{{ $total_products }}">0</span>
                                            </h4>
                                            {{-- <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                                <span class="counter-value" data-target="{{ $total_news }}">0</span>
                                            </h4>
                                            {{-- <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                        ...
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-title bg-warning-subtle rounded fs-3">
                                                <i class="bx bx-news text-warning"></i>
                                            </span>
                                        </div>
                                    </div>
                                </div>
