                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex">
                        <ul class="flex-grow-1 nav nav-tabs-custom rounded card-header-tabs border-bottom-0"
                            role="tablist">
                            <li class="nav-item">
                                <a class="nav-link {{ session('activeTab', 'homepageData') == 'homepageData' ? 'active' : '' }}"
                                    data-bs-toggle="tab" href="#homepageData" role="tab">
                                    @if (!request()->routeIs('cms.homepage.edit') && !request()->routeIs('cms.homepage.show'))
                                        {{ __('Homepage') }}
                                    @endif
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ session('activeTab') == 'homepageHeroImage' ? 'active' : '' }}"
                                    data-bs-toggle="tab" href="#homepageHeroImage" role="tab"
                                    @if (!request()->routeIs('cms.homepage.edit') && !request()->routeIs('cms.homepage.show')) style="display: none;" @endif>
                                    {{ __('Thumbnail of the Video') }}
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            {{-- Edit Homepage --}}
                            <div class="tab-pane nav-link {{ session('activeTab', 'homepageData') == 'homepageData' ? 'active' : '' }}"
                                id="homepageData" role="tabpanel">
                                <div class="live-preview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="hero-title" :value="__('Hero Section Title')" /><span
                                                        class="text-danger">*</span>
                                                    <x-text-input type="text" name="hero_title" :value="old('hero_title', $record->hero_title ?? '')"
                                                        class="form-control" :error="$errors->has('hero_title')"
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="hero-description" :value="__('Hero Section Description')" /><span
                                                        class="text-danger">*</span>
                                                    <x-text-input type="text" name="hero_description"
                                                        :value="old(
                                                            'hero_description',
                                                            $record->hero_description ?? '',
                                                        )" class="form-control" :error="$errors->has('hero_description')"
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="feature-left-title" :value="__('Feature Section Left Title')" /><span
                                                        class="text-danger">*</span>
                                                    <x-text-input type="text" name="feature_left_title"
                                                        :value="old(
                                                            'feature_left_title',
                                                            $record->feature_left_title ?? '',
                                                        )" class="form-control" :error="$errors->has('feature_left_title')"
                                                        placeholder="Enter the feature section left title" />
                                                    <x-input-error class="mt-2" :messages="$errors->get('feature_left_title')" />
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="feature-left-description"
                                                        :value="__('Feature Section Left Description')" /><span class="text-danger">*</span>
                                                    <x-text-input type="text" name="feature_left_description"
                                                        :value="old(
                                                            'feature_left_description',
                                                            $record->feature_left_description ?? '',
                                                        )" class="form-control" :error="$errors->has('feature_left_description')"
                                                        placeholder="Enter the feature section left description" />
                                                    <x-input-error class="mt-2" :messages="$errors->get('feature_left_description')" />
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="feature-center-title" :value="__('Feature Section Center Title')" /><span
                                                        class="text-danger">*</span>
                                                    <x-text-input type="text" name="feature_center_title"
                                                        :value="old(
                                                            'feature_center_title',
                                                            $record->feature_center_title ?? '',
                                                        )" class="form-control" :error="$errors->has('feature_center_title')"
                                                        placeholder="Enter the feature section center title" />
                                                    <x-input-error class="mt-2" :messages="$errors->get('feature_center_title')" />
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="feature-center-description"
                                                        :value="__('Feature Section Center Description')" /><span class="text-danger">*</span>
                                                    <x-text-input type="text" name="feature_center_description"
                                                        :value="old(
                                                            'feature_center_description',
                                                            $record->feature_center_description ?? '',
                                                        )" class="form-control" :error="$errors->has('feature_center_description')"
                                                        placeholder="Enter the feature section center description" />
                                                    <x-input-error class="mt-2" :messages="$errors->get('feature_center_description')" />
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="feature-right-title" :value="__('Feature Section Right Title')" /><span
                                                        class="text-danger">*</span>
                                                    <x-text-input type="text" name="feature_right_title"
                                                        :value="old(
                                                            'feature_right_title',
                                                            $record->feature_right_title ?? '',
                                                        )" class="form-control" :error="$errors->has('feature_right_title')"
                                                        placeholder="Enter the feature section right title" />
                                                    <x-input-error class="mt-2" :messages="$errors->get('feature_right_title')" />
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="feature-right-description"
                                                        :value="__('Feature Section Right Description')" /><span class="text-danger">*</span>
                                                    <x-text-input type="text" name="feature_right_description"
                                                        :value="old(
                                                            'feature_right_description',
                                                            $record->feature_right_description ?? '',
                                                        )" class="form-control" :error="$errors->has('feature_right_description')"
                                                        placeholder="Enter the feature section right description" />
                                                    <x-input-error class="mt-2" :messages="$errors->get('feature_right_description')" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    @if (isset($record) && $record->video_name)
                                                        <p class="mt-2">Current File:
                                                            <strong>{{ $record->video_name }}</strong></p>
                                                        @if (isset($record) && $record->video_path)
                                                            ...
                                                            <div id="videoPreviewModal" class="modal fade zoomIn"
                                                                tabindex="-1"
                                                                aria-labelledby="videoPreviewModal_label"
                                                                aria-hidden="true">
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="videoPreviewModal_label">Preview
                                                                                Video</h5>
                            ...
                            <div class="tab-pane nav-link {{ session('activeTab') == 'homepageHeroImage' ? 'active' : '' }}"
                                id="homepageHeroImage" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">{{ $hero_title ?? '' }} Images</h5>
                                        </div>
                                        <div class="card-body">
                                            <table id="homepage-images"
                                                class="table table-bordered dt-responsive table-striped align-middle"
                                                style="width: 100%">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center">No</th>
                                                        <th class="text-center">Set Thumbnail Image</th>
                                                        <th>Name</th>
                                                        <th>Size</th>
                                                        <th>Updated At</th>
                                                            ...
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <input class="form-check-input switch-default"
                                                                        ...
                                                                        @if ($image->is_default == true) checked @endif
                                                                        data-id={{ $image->id }}>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="dropdown d-inline-block">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('cms.homepage.delete.image', $image->id) }}"
                                                                            method="post"
    ...
    @push('custom-script')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    if (!document.querySelector('input[name="is_event"]:checked')) {
                        // Create a hidden field if the checkbox is unchecked
                        const hiddenField = document.createElement('input');
                        hiddenField.type = 'hidden';
                        hiddenField.name = 'is_event';
                        hiddenField.value = '0';
        ...
        <script>
            ...
            $(document).ready(function() {
                // initiate datatable
                $("#homepage-images").DataTable({
                    response: true
                });

                $('.switch-default').on('change', function() {
                    var imgId = $(this).data('id');
                    var isDefault = $(this).is(':checked') ? true : false;
                    var updateUrl = "{{ route('cms.homepage.update.default.image', ':homepageHeroImageId') }}";
                    var url = updateUrl.replace(':homepageHeroImageId', imgId);
        ...
        <script>
            ...
            var myDropzone = new Dropzone("#image-dropzone", {
                url: "{{ route('cms.homepage.upload.images') }}", // URL untuk upload
                params: {
                    encrypted: encrypted
                },
                thumbnailWidth: 80,
            ...
            myDropzone.on("errormultiple", function(files, errorMessage) {
                files.forEach(function(file) {
                    ...
                    // Check if errorMessage is an object with a message property
                    if (typeof errorMessage === 'object') {
                        if (errorMessage.message) {
                            errorText = errorMessage.message;
                        }

                        // Check if there's an errors object with validation errors
                        if (errorMessage.errors) {
                            try {
                                errorText = Object.values(errorMessage.errors).flat().join(", ");
                            } catch (e) {
                                console.error("Error processing error messages:", e);
                                errorText = "An error occurred during upload";
                            }
                        }
                    } else if (typeof errorMessage === 'string') {
                        // If errorMessage is just a string, use it directly
                    ...
                    file.previewElement.querySelector("[data-dz-errormessage]").textContent = errorText;
                    checkForErrors();
                });
            });
