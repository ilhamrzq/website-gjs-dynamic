                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex">
                        <ul class="flex-grow-1 nav nav-tabs-custom rounded card-header-tabs border-bottom-0"
                            role="tablist">
                            <li class="nav-item">
                                <a class="nav-link {{ session('activeTab', 'bookingPageData') == 'bookingPageData' ? 'active' : '' }}"
                                    data-bs-toggle="tab" href="#bookingPageData" role="tab">
                                    @if (!request()->routeIs('cms.booking-page.edit') && !request()->routeIs('cms.booking-page.show'))
                                        {{ __('Booking Page') }}
                                    @endif

                                    @if (request()->routeIs('cms.booking-page.edit') || request()->routeIs('cms.booking-page.show'))
                                        {{ __('Edit Booking Page') }}
                                    @endif
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{ session('activeTab') == 'bookingPageImage' ? 'active' : '' }}"
                                    data-bs-toggle="tab" href="#bookingPageImage" role="tab"
                                    @if (!request()->routeIs('cms.booking-page.edit') && !request()->routeIs('cms.booking-page.show')) style="display: none;" @endif>
                                    {{ __('Images') }}
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            {{-- Edit Homepage --}}
                            <div class="tab-pane nav-link {{ session('activeTab', 'bookingPageData') == 'bookingPageData' ? 'active' : '' }}"
                                id="bookingPageData" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="row align-items-center">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="page-name" :value="__('Page Name')" /><span
                                                        class="text-danger">*</span>
                                                    <x-text-input type="text" name="page_name" :value="old('page_name', $record->page_name ?? '')"
                                                        class="form-control" :error="$errors->has('page_name')"
                            ...
                            <div class="tab-pane nav-link {{ session('activeTab') == 'bookingPageImage' ? 'active' : '' }}"
                                id="bookingPageImage" role="tabpanel">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="dropdown d-inline-block">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('cms.booking-page.delete.image', $image->id) }}"
                                                                            method="post"
    ...
    @push('custom-script')
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.switch-default').on('change', function() {
                    ...
                    var updateUrl =
                        "{{ route('cms.booking-page.update.default.image', ':bookingPageImageId') }}";
                    var url = updateUrl.replace(':bookingPageImageId', imgId);
        ...
        <script>
            ...
            var myDropzone = new Dropzone("#image-dropzone", {
                url: "{{ route('cms.booking-page.upload.images') }}", // URL untuk upload
                params: {
                    encrypted: encrypted
                },
                thumbnailWidth: 80,
