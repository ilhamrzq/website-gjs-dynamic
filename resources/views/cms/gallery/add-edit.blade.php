                ...
                <div class="card">
                        ...
                        <ul class="flex-grow-1 nav nav-tabs-custom rounded card-header-tabs border-bottom-0"
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ session('activeTab', 'galleryData') == 'galleryData' ? 'active' : '' }}"
                                    ...
                                    @if (!request()->routeIs('cms.galleries.edit') && !request()->routeIs('cms.galleries.show'))
                                        {{ __('Gallery') }}
                                    @endif
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ session('activeTab') == 'galleryImage' ? 'active' : '' }}"
                                    data-bs-toggle="tab" href="#galleryImage" role="tab"
                                    @if (!request()->routeIs('cms.galleries.edit') && !request()->routeIs('cms.galleries.show')) style="display: none;" @endif>
                                    {{ __('Images') }}
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="row align-items-center">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="category-name-id" :value="__('Category Name ID')" /><span
                                                        class="text-danger">*</span>
                                                    <x-text-input type="text" name="category_name_id"
                                                        :value="old(
                                                            'category_name_id',
                                                            $record->category_name_id ?? '',
                                                        )" class="form-control" :error="$errors->has('category_name_id')"
                                                        placeholder="Enter the category name id title" />
                                                    <x-input-error class="mt-2" :messages="$errors->get('category_name_id')" />
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <x-input-label for="category-name-en" :value="__('Category Name EN')" /><span
                                                        class="text-danger">*</span>
                                                    <x-text-input type="text" name="category_name_en"
                                                        :value="old(
                                                            'category_name_en',
                                                            $record->category_name_en ?? '',
                                                        )" class="form-control" :error="$errors->has('category_name_en')"
                                                        placeholder="Enter the category name en title" />
                                                    <x-input-error class="mt-2" :messages="$errors->get('category_name_en')" />
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane nav-link {{ session('activeTab') == 'galleryImage' ? 'active' : '' }}"
                                id="galleryImage" role="tabpanel">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="dropdown d-inline-block">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('cms.galleries.delete.image', $image->id) }}"
                                                                            method="post"
    ...
    @push('custom-script')
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.switch-default').on('change', function() {
                    ...
                    var updateUrl = "{{ route('cms.galleries.update.default.image', ':galleryImageId') }}";
                    var url = updateUrl.replace(':galleryImageId', imgId);
        ...
        <script>
            ...
            var myDropzone = new Dropzone("#image-dropzone", {
                url: "{{ route('cms.galleries.upload.images') }}", // URL untuk upload
                params: {
                    encrypted: encrypted
                },
                thumbnailWidth: 80,
